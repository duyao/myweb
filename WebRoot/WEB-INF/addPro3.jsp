																								...
																								<table width="95%" border="0" cellspacing="0"
																									...
																									<tr>
																										<td height="20" style="cursor: hand"
																											...
																											onmouseout="this.style.borderStyle='none'">
																											<span class="STYLE3"><a
																												href="http://localhost:8080/myweb/ShowPro?pageNow=1">查看项目</a>
																											</span>
																										</td>
																									</tr>
																								</table>
																								...
																								<table width="95%" border="0" cellspacing="0"
																									...
																									<tr>
																										<td height="20" style="cursor: hand"
																											...
																											onmouseout="this.style.borderStyle='none'">
																											<span class="STYLE3"><a
																												href="http://localhost:8080/myweb/UpdateProject?type=addView">添加项目</a>
																											</span>
																										</td>
																									</tr>
																								</table>
...
imgmenu.background="images/main_48.jpg";
            ...
            -->
						...
						<tr>
							<td>
								添加项目共需3步，现在是第3步：添加团队成员
								<hr>
								<form action="/myweb/UpdateProject?type=add" method="post">
...
%>
										<tr>
											...
											<td><%=proid %><input size="30" type="hidden"
													value="<%=proid%>" name="proid" />
											</td>
										...
										<tr>
											...
											<td><%=proname %><input size="30" type="hidden"
													name="proname" value="<%=proname %>" />
											</td>
										...
										<tr>
											...
											<td><%=des %><input size="30" type="hidden" name="des"
													value="<%=des %>" />
											</td>
										</tr>
									</table>
									...
									<tr>
										<td>
											<table onmouseover="changeto()" onmouseout="changeback()"
												cellspacing="0" border="1">
												<input size="30" type="hidden" name="leader"
													value="<%=leader.getStuid()%>" />
												<tr>
													<td>
														学号
													</td>
...
%>
												...
												<tr>
													新的团队号是<%=teamid %>，请选择团队成员
													<input size="30" type="hidden" name="teamid"
														value="<%=teamid %>" />
